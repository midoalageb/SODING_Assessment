...
public class TaskDbHelper extends SQLiteOpenHelper {
    ...
    /**
     * Additional constructor to run automated tests on Test DB instead of live one
     * @param context
     * @param debug
     */
    public TaskDbHelper(Context context, boolean debug) {
        super(context, Constants.DB_NAME_TEST, null, DATABASE_VERSION);
    }
